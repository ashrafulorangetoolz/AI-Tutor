  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card>
          <CardBody>
            ...
            <BarChart
              data={SCHOOL_SUBJECT_PERFORMANCE.map((s) => ({ label: s.subject, value: s.avg }))}
              suffix="%"
            />
          </CardBody>
        </Card>
          ...
          <ul className="space-y-2">
            {topStudents.map((s, i) => (
              ...
              >
                ...
                <Badge tone={s.avgScore >= 80 ? "green" : s.avgScore >= 60 ? "blue" : "amber"}>
                  {s.avgScore}%
                </Badge>
              </li>
            ))}
      ...
      <p className="mt-6 text-sm text-muted">
        Automated weekly reports are emailed to school admins every Sunday at 8:00 PM.
      </p>
    </>
  );
}
